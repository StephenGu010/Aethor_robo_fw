...
#define PLATFORM_FORMAL_UART_INSTANCE_INDEX (1U)
#define PLATFORM_FORMAL_UART_BAUDRATE (BOARD_FORMAL_UART_BAUDRATE)
#define PLATFORM_FORMAL_LINK_VALIDATED (BOARD_FORMAL_UART_VALIDATED)
