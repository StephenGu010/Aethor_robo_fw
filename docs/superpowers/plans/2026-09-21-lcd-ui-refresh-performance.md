...
- [x] **Step 1: Define the 10 MHz divider in the fake HAL**
...
- [x] **Step 2: Change the platform expectation before production code**

```c
CHECK(fake_hal.spi->Init.BaudRatePrescaler == SPI_BAUDRATEPRESCALER_8);
```

- [x] **Step 3: Add task/display expectations**
...
- [x] **Step 5: Keep the failing contract uncommitted until its implementation is green**
...
- [x] **Step 1: Add the task-owned dirty flag**
...
- [x] **Step 2: Mark actual model mutations**
...
- [x] **Step 3: Consume the flag in graphics service**
...
- [x] **Step 4: Run the task regression and verify GREEN**
...
- [x] **Step 1: Add a static source contract before production modification**
...
- [x] **Step 3: Implement the fixed animation rectangle**
...
- [x] **Step 4: Run build-contract and render regressions**
...
- [x] **Step 5: Commit the dirty-area slice**
...
- [x] **Step 1: Define the public diagnostic copy**
...
- [x] **Step 2: Accumulate one LVGL refresh**
...
- [x] **Step 3: Copy coherent statistics in UiTask**
...
- [x] **Step 4: Display compact frame metrics**
...
- [x] **Step 5: Run UI regressions and verify GREEN**
...
- [x] **Step 6: Commit the statistics slice**
...
- [x] **Step 1: Implement the minimal divider change**
...
- [x] **Step 2: Run the LCD platform regression and verify GREEN**
...
- [x] **Step 3: Commit the clock slice**
...
- [x] **Step 1: Run the complete host and four-target verification**
...
- [x] **Step 2: Verify scope and repository state**
...
- [x] **Step 3: Report the evidence boundary**
