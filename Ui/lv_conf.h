...
/** @brief Fail closed locally; never enter the firmware's global fatal path. */
void debug_ui_lvgl_assert_failed(void);
#define LV_ASSERT_HANDLER debug_ui_lvgl_assert_failed();
#define LV_MEM_FAILURE_HANDLER debug_ui_lvgl_assert_failed
